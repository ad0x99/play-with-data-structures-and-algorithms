 ...
 *
 * Time complexity of the ping function: O(n) where n is the number of elements in the queue. This is because we may need to shift elements from the queue if they are older than 3000 milliseconds. The average time complexity is O(n)/n = O(1).
 *
