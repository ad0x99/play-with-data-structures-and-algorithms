 ...
 * QUESTION
 *
 * You're hosting an event at a food festival and want to showcase the best possible pairing of 2 dishes from the festival that complement each other's flavor profile
 *
...
const array1 = [-3, -5, 1, 7];
const array2 = [3, 5, 7, 2, 6, 8, 1];
const array3 = [2, 5, -4, -7, 12, 100, -25];
console.log(sweetAndSavory(array1));
console.log(sweetAndSavory(array2));
console.log(sweetAndSavory(array3));
